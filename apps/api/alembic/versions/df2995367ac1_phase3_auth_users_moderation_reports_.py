...
down_revision: Union[str, None] = 'b7c3e9d94599'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_analytics_events_property_id'), 'analytics_events', ['property_id'], unique=False)
    ...
    op.create_index(op.f('ix_moderation_logs_property_id'), 'moderation_logs', ['property_id'], unique=False)
    ...
    op.add_column('profiles', sa.Column('preferred_language', sa.String(length=8), server_default='az', nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_analytics_events_property_id'), table_name='analytics_events')
