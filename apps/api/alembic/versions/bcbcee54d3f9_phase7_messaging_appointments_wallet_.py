...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_verification_tokens_kind"),
        "verification_tokens",
        ["kind"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_conversations_property_id"),
        "conversations",
        ["property_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_viewing_appointments_owner_id"),
        "viewing_appointments",
        ["owner_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_viewing_appointments_requester_id"),
        "viewing_appointments",
        ["requester_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_viewing_appointments_status"),
        "viewing_appointments",
        ["status"],
        unique=False,
    )
    ...
    op.add_column(
        "notifications", sa.Column("kind", sa.String(length=32), nullable=False)
    )
    op.add_column(
        "notifications", sa.Column("link", sa.String(length=500), nullable=True)
    )
    op.create_index(
        op.f("ix_notifications_kind"), "notifications", ["kind"], unique=False
    )
    op.add_column(
        "properties", sa.Column("promotion_tier", sa.String(length=24), nullable=True)
    )
    op.add_column(
        "properties",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_viewing_appointments_status"), table_name="viewing_appointments"
    )
    op.drop_index(
        op.f("ix_viewing_appointments_requester_id"), table_name="viewing_appointments"
    )
    op.drop_index(
        op.f("ix_viewing_appointments_property_id"), table_name="viewing_appointments"
    )
    op.drop_index(
        op.f("ix_viewing_appointments_owner_id"), table_name="viewing_appointments"
    )
